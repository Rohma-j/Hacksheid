...
app.post("/search",...) => line 19 => A01: Broken Access Control => no restriction on who can access data.<br>
 ...
 if (err) throw err;  => line 24 => A05:2021 – Security Misconfiguration => error is not manage properly it can crash the server or may leak some data.<br>
 res.json(results); => line 25 => A02 — Cryptographic Failures =>result is directly shown to user.<br>